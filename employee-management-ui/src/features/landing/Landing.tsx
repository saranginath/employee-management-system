                            ...
                            <div className="grid grid-cols-[auto_1fr] bg-white">
                                ...
                                <div className="hidden w-32 flex-col gap-1 border-r border-slate-100 bg-slate-50/60 p-3 sm:flex">
                                    {[
                                        ...
                                        <div
                                            key={item.label}
                                            className={`rounded-lg px-3 py-2 text-xs font-medium ${item.active
                ...
                <div className="mx-auto grid max-w-5xl items-center gap-10 md:grid-cols-2">
                    <div>
                        ...
                        <p className="mt-4 text-slate-600">
                            ...
                            spreadsheets. Today it helps HR teams of every size keep
                            employee records, attendance and leave in one place — so people
                            spend less time on admin and more time on people.
                        </p>
            ...
            <section id="contact" className="px-6 py-16 md:px-10">
                <div className="mx-auto max-w-5xl">
                    ...
                    <div className="mt-10 grid gap-8 rounded-3xl border border-slate-100 bg-white p-6 shadow-sm md:grid-cols-5 md:p-8">
                        ...
                        {/* form */}
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 md:col-span-3" noValidate>
