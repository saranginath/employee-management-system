...
import { employeeSchema, type EmployeeForm } from "../../features/employee/employeeSchema";
...
import { FiUser, FiMail, FiBriefcase, FiDollarSign, FiArrowLeft } from "react-icons/fi";
...
export default function EmployeeFormPage() {
    ...
    const { data: employeeData, isLoading: employeeLoading } = useGetEmployeeByIdQuery(id!, {
        skip: !isEditMode,
    });

    const { data: departmentResponse, isLoading: departmentLoading } = useGetDepartmentsQuery();
                        ...
                        <div className="flex items-center gap-5">
                            ...
                            <div>
                                ...
                                <p className="text-blue-100 mt-1">
                                    {isEditMode ? "Update employee details" : "Add new employee to organization"}
                                </p>
                            </div>
                        </div>
                    ...
                    <section>
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-slate-500">Employee role and salary details</p>
                            </div>
                        </div>
