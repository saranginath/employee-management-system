...
export const getPerformanceByIdService = async (
    id: string
) => {
    const review =
        await performanceRepository.getPerformanceById(id);
...
export const updatePerformanceService = async (
    ...
    const review =
        await performanceRepository.updatePerformance(id, data);
...
export const deletePerformanceService = async (
    ...
    const review =
        await performanceRepository.deletePerformance(id);
