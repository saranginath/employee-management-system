...
export const getAnnouncementsController = asyncHandler(async (_req: Request, res: Response) => {
...
export const getAnnouncementByIdController = asyncHandler(async (req: Request, res: Response) => {
    const announcement = await getAnnouncementByIdService(req.params.id as string);
