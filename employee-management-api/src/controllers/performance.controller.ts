...
export const createPerformanceController = asyncHandler(async (req: Request, res: Response) => {
...
export const getPerformanceController = asyncHandler(async (_req: Request, res: Response) => {
...
export const getPerformanceByIdController = asyncHandler(async (req: Request, res: Response) => {
...
export const updatePerformanceController = asyncHandler(async (req: Request, res: Response) => {
...
export const deletePerformanceController = asyncHandler(async (req: Request, res: Response) => {
