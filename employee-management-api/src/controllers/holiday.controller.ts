...
export const getHolidayController = asyncHandler(async (_req: Request, res: Response) => {
...
export const getHolidayByIdController = asyncHandler(async (req: Request, res: Response) => {
