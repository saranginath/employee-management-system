...
export const createSettings = asyncHandler(
    async (
        ...
        const data =
            createSettingsSchema.parse(req.body);


        const settings =
            await createSettingsService(data);
    ...
    asyncHandler(
        async (
            ...
            await sendTestEmail({
                ...
                smtpPort:
                    settings.emailSettings.smtpPort,


                secure:
                    settings.emailSettings.secure,


                username:
                    settings.emailSettings.username,
