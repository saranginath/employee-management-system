...
export const getTodayAttendance = async (employeeId: string, today: Date) => {
...
export const getAttendanceSummary = async (employeeId: string) => {
...
export const getRecentLeaves = async (employeeId: string) => {
  return Leave.find({
    employee: employeeId,
  })
    .sort({
