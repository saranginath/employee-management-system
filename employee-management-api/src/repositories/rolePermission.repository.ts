...
export const createRolePermissionRepo =
    (data: any) => {
...
export const getRoleByNameRepo =
    (role: string) => {
...
export const updateRolePermissionRepo =
    (
        id: string,
        data: any
    ) => {

        return RolePermission.findByIdAndUpdate(
            id,
            data,
            {
                new: true,
...
export const deleteRolePermissionRepo =
    (id: string) => {
